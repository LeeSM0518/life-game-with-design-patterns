...
public class Direction {
  ...
  public static final int BITS_NORTH = 0x0001;
  public static final int BITS_SOUTH = 0x0002;
  public static final int BITS_EAST = 0x0004;
  public static final int BITS_WEST = 0x0008;
  public static final int BITS_NORTHEAST = 0x0010;
  public static final int BITS_NORTHWEST = 0x0020;
  public static final int BITS_SOUTHEAST = 0x0040;
  public static final int BITS_SOUTHWEST = 0x0080;
  public static final int BITS_NONE = 0x0000;
  public static final int BITS_ALL = 0x00ff;
  ...
  private static final class Immutable extends Direction {
    ...
    private static final String message =
        "May not modify Direction contant (Direction.NORTH, etc.)";
